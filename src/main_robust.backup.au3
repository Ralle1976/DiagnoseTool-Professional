...
#include "lib/sql_editor.au3"  ; SQL-Editor für SQLite-Datenbanken
...
;~     $idToolLogTester = GUICtrlCreateMenuItem("Log-Parser Tester", $idTools)
    ...
    While 1
        Switch GUIGetMsg()
            ...
            Case $idToolSQLEditor, $idBtnSQLEditor
                ; SQL-Editor starten
                _ShowSQLEditor($g_sCurrentDB)

;~             Case $idToolLogTester, $idBtnLogParser
;~                 ; Log-Parser Testtool starten
;~                 ShellExecute(@ScriptDir & "\..\log-parser-tester.au3")
