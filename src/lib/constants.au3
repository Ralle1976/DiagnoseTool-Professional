...
; Konstanten für WinAPI Z-Order
;~ Global Const $HWND_BOTTOM = 1
;~ Global Const $HWND_TOP = 0
;~ Global Const $SWP_NOMOVE = 0x0002
;~ Global Const $SWP_NOSIZE = 0x0001

; ListBox-Konstanten für Auto-Vervollständigung
;~ Global Const $LBN_DBLCLK = 2    ; Double-click
;~ Global Const $LBN_SELCHANGE = 1 ; Selection change
...
Global Const $LOG_FORMAT_JSON_GENERIC = 5  ; Konstante für allgemeines JSON-Format
Global Const $LOG_FORMAT_JSON_INCOMPLETE = 6 ; Neue Konstante für unvollständige JSON-Einträge
